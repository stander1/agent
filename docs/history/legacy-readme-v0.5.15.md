# AgentLite Historical README Snapshot

> Archive note: this file preserves the repository homepage before the
> competition-facing documentation calibration. It is part of the development
> record and does not define the current release claims. See the repository
> root `README.md` for the current validated submission surface.
