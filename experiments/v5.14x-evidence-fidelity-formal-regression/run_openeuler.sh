...
RUN_ROOT="${AGENTLITE_V514X_RUN_ROOT:-runs/v5.14x-evidence-fidelity-formal-regression/$EXP_ID}"
TRACE_ROOT="${AGENTLITE_V514X_TRACE_ROOT:-.agentlite-exp/v5.14x-evidence-fidelity-formal-regression/$EXP_ID}"
EXPORT_BASE="${AGENTLITE_V514X_EXPORT_BASE:-exports/v5.14x-evidence-fidelity-formal-regression-$EXP_ID}"
...
export AGENTLITE_V514B_EXPERIMENT_LABEL="v5.14x"
export AGENTLITE_V514B_PHASE_LABEL="evidence fidelity formal regression"
export AGENTLITE_V514B_MEMORY_SCOPE_PREFIX="v514x"
...
export AGENTLITE_V514B_POST_VERIFY_JSON="$RUN_ROOT/evidence_fidelity_formal_report.json"
export AGENTLITE_V514B_POST_VERIFY_MARKDOWN="$RUN_ROOT/evidence_fidelity_formal_report.md"
export AGENTLITE_V514B_RESUME="${AGENTLITE_V514X_RESUME:-0}"
