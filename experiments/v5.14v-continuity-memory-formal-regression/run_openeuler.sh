...
EXP_ID="${AGENTLITE_V514V_EXP_ID:-$(date +%Y%m%d-%H%M%S)}"
RUN_ROOT="${AGENTLITE_V514V_RUN_ROOT:-runs/v5.14v-continuity-memory-formal-regression/$EXP_ID}"
TRACE_ROOT="${AGENTLITE_V514V_TRACE_ROOT:-.agentlite-exp/v5.14v-continuity-memory-formal-regression/$EXP_ID}"
EXPORT_BASE="${AGENTLITE_V514V_EXPORT_BASE:-exports/v5.14v-continuity-memory-formal-regression-$EXP_ID}"
...
export AGENTLITE_V514B_EXPERIMENT_LABEL="v5.14v"
export AGENTLITE_V514B_PHASE_LABEL="continuity memory formal regression"
export AGENTLITE_V514B_MEMORY_SCOPE_PREFIX="v514v"
...
export AGENTLITE_V514B_POST_VERIFY_JSON="$RUN_ROOT/continuity_memory_formal_report.json"
export AGENTLITE_V514B_POST_VERIFY_MARKDOWN="$RUN_ROOT/continuity_memory_formal_report.md"
export AGENTLITE_V514B_RESUME="${AGENTLITE_V514V_RESUME:-0}"
