...
EXP_ID="${AGENTLITE_V514Z_EXP_ID:-$(date +%Y%m%d-%H%M%S)}"
RUN_ROOT="${AGENTLITE_V514Z_RUN_ROOT:-runs/v5.14z-active-fact-terminal-delivery-formal/$EXP_ID}"
TRACE_ROOT="${AGENTLITE_V514Z_TRACE_ROOT:-.agentlite-exp/v5.14z-active-fact-terminal-delivery-formal/$EXP_ID}"
EXPORT_BASE="${AGENTLITE_V514Z_EXPORT_BASE:-exports/v5.14z-active-fact-terminal-delivery-formal-$EXP_ID}"
...
export AGENTLITE_V514B_EXPERIMENT_LABEL="v5.14z"
export AGENTLITE_V514B_PHASE_LABEL="active fact terminal delivery formal regression"
export AGENTLITE_V514B_MEMORY_SCOPE_PREFIX="v514z"
...
export AGENTLITE_V514B_POST_VERIFY_JSON="$RUN_ROOT/active_fact_terminal_delivery_formal_report.json"
export AGENTLITE_V514B_POST_VERIFY_MARKDOWN="$RUN_ROOT/active_fact_terminal_delivery_formal_report.md"
export AGENTLITE_V514B_RESUME="${AGENTLITE_V514Z_RESUME:-0}"
