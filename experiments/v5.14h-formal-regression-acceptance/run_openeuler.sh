...
EXP_ID="${AGENTLITE_V514H_EXP_ID:-$(date +%Y%m%d-%H%M%S)}"
RUN_ROOT="${AGENTLITE_V514H_RUN_ROOT:-runs/v5.14h-formal-regression-acceptance/$EXP_ID}"
TRACE_ROOT="${AGENTLITE_V514H_TRACE_ROOT:-.agentlite-exp/v5.14h-formal-regression-acceptance/$EXP_ID}"
EXPORT_BASE="${AGENTLITE_V514H_EXPORT_BASE:-exports/v5.14h-formal-regression-acceptance-$EXP_ID}"
...
export AGENTLITE_V514B_EXPERIMENT_LABEL="v5.14h"
export AGENTLITE_V514B_PHASE_LABEL="formal regression acceptance"
export AGENTLITE_V514B_MEMORY_SCOPE_PREFIX="v514h"
...
export AGENTLITE_V514B_POST_VERIFY_JSON="$RUN_ROOT/formal_regression_report.json"
export AGENTLITE_V514B_POST_VERIFY_MARKDOWN="$RUN_ROOT/formal_regression_report.md"
export AGENTLITE_V514B_RESUME="${AGENTLITE_V514H_RESUME:-0}"
