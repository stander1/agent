...
EXP_ID="${AGENTLITE_V514E_EXP_ID:-$(date +%Y%m%d-%H%M%S)}"
RUN_ROOT="${AGENTLITE_V514E_RUN_ROOT:-runs/v5.14e-current-task-fidelity-acceptance/$EXP_ID}"
TRACE_ROOT="${AGENTLITE_V514E_TRACE_ROOT:-.agentlite-exp/v5.14e-current-task-fidelity-acceptance/$EXP_ID}"
EXPORT_BASE="${AGENTLITE_V514E_EXPORT_BASE:-exports/v5.14e-current-task-fidelity-acceptance-$EXP_ID}"
...
export AGENTLITE_V514B_EXPERIMENT_LABEL="v5.14e"
export AGENTLITE_V514B_MEMORY_SCOPE_PREFIX="v514e"
