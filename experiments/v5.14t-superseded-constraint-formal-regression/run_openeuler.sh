...
EXP_ID="${AGENTLITE_V514T_EXP_ID:-$(date +%Y%m%d-%H%M%S)}"
RUN_ROOT="${AGENTLITE_V514T_RUN_ROOT:-runs/v5.14t-superseded-constraint-formal-regression/$EXP_ID}"
TRACE_ROOT="${AGENTLITE_V514T_TRACE_ROOT:-.agentlite-exp/v5.14t-superseded-constraint-formal-regression/$EXP_ID}"
EXPORT_BASE="${AGENTLITE_V514T_EXPORT_BASE:-exports/v5.14t-superseded-constraint-formal-regression-$EXP_ID}"
...
export AGENTLITE_V514B_EXPERIMENT_LABEL="v5.14t"
export AGENTLITE_V514B_PHASE_LABEL="superseded constraint formal regression"
export AGENTLITE_V514B_MEMORY_SCOPE_PREFIX="v514t"
...
export AGENTLITE_V514B_POST_VERIFY_JSON="$RUN_ROOT/superseded_constraint_formal_report.json"
export AGENTLITE_V514B_POST_VERIFY_MARKDOWN="$RUN_ROOT/superseded_constraint_formal_report.md"
export AGENTLITE_V514B_RESUME="${AGENTLITE_V514T_RESUME:-0}"
