...
EXP_ID="${AGENTLITE_V514J_EXP_ID:-$(date +%Y%m%d-%H%M%S)}"
RUN_ROOT="${AGENTLITE_V514J_RUN_ROOT:-runs/v5.14j-semantic-fidelity-formal-regression/$EXP_ID}"
TRACE_ROOT="${AGENTLITE_V514J_TRACE_ROOT:-.agentlite-exp/v5.14j-semantic-fidelity-formal-regression/$EXP_ID}"
EXPORT_BASE="${AGENTLITE_V514J_EXPORT_BASE:-exports/v5.14j-semantic-fidelity-formal-regression-$EXP_ID}"
...
export AGENTLITE_V514B_EXPERIMENT_LABEL="v5.14j"
export AGENTLITE_V514B_PHASE_LABEL="semantic fidelity formal regression"
export AGENTLITE_V514B_MEMORY_SCOPE_PREFIX="v514j"
...
export AGENTLITE_V514B_POST_VERIFY_JSON="$RUN_ROOT/semantic_fidelity_regression_report.json"
export AGENTLITE_V514B_POST_VERIFY_MARKDOWN="$RUN_ROOT/semantic_fidelity_regression_report.md"
export AGENTLITE_V514B_RESUME="${AGENTLITE_V514J_RESUME:-0}"
